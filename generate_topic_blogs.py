...
POSTS = [
    ...
    },
    {
        ...
        "description": "How much you can borrow on a $100k NZ salary in 2026 — comparing test rates, living expenses, and lender scorecards across ANZ, ASB, BNZ, Westpac, and non-banks.",
        "keywords": [
        ...
        "sections": [
            ...
            ("Lender-by-Lender Estimate on $100k Salary", "<p style=\"margin-bottom:2rem;\">As a 2026 guide (clean credit, no other debts, single applicant, 20% deposit assumed): <strong>ANZ</strong> ~$580-620k, <strong>ASB</strong> ~$570-610k, <strong>BNZ</strong> ~$620-680k, <strong>Westpac</strong> ~$580-630k, <strong>TSB / SBS / Co-operative Bank</strong> ~$540-600k. Specialist non-banks vary more widely. These are estimates only — Finch produces lender-specific quotes free of charge based on your real income and expenses.</p>"),
    ...
    },
    {
        ...
        "sections": [
            ("The Core Difference", "<p style=\"margin-bottom:2rem;\">Walking into your own bank gives you access to that bank's rates, scorecard, and product range — nothing more. A New Zealand mortgage broker (like Finch) compares your scenario across the full panel of <strong>ANZ, ASB, BNZ, Westpac, TSB, SBS, The Co-operative Bank, Heartland</strong>, plus the specialist non-bank market (<strong>Resimac, Pepper Money, Avanti, Liberty, Basecorp, Bluestone</strong>). Because every lender's pricing, test rate, and credit appetite differs week to week, the spread between best and worst offer for the same client is usually <strong>0.30-0.60 percentage points</strong> — equivalent to $1,500-$3,000 of saving per year on a $500,000 loan.</p>"),
    ...
    },
    {
        ...
        "sections": [
            ...
            ("Step 2 — Check Panel Size", "<p style=\"margin-bottom:2rem;\">Ask how many lenders the broker works with. A serious NZ mortgage broker should have at least 15 lenders on panel — all major NZ banks (ANZ, ASB, BNZ, Westpac), the major regional/registered banks (TSB, SBS, The Co-operative Bank, Heartland), and a healthy suite of specialist non-banks (Resimac, Pepper Money, Avanti, Liberty, Bluestone, Basecorp). A broker with only 2-3 lenders is functionally a bank salesperson.</p>"),
