# SEO Guidelines for Finch Mortgages Content

This document outlines SEO best practices and requirements for all Finch Mortgages blog/guide content to maximize organic search visibility and rankings. See `context/target-keywords.md` for current topic clusters and cannibalization risks, and `context/brand-voice.md` for tone/compliance rules — never invent rates, lender terms, or approval odds when optimizing for keywords.
...
- **Use variations**: Don't repeat exact phrase robotically
  - Example: "mortgage refinance" → "refinancing your mortgage" → "switch lenders"
- **Question formats**: Include conversational variations
  - "How to refinance a mortgage" vs "refinancing your mortgage"
- **Semantic keywords**: Use related terms to support topical authority
  - For "mortgage refinance": include "switching lenders", "refixing your rate", "break fees"

### Keyword Stuffing (Avoid)
❌ "Mortgage refinancing is important. Mortgage refinancing helps homeowners. Our mortgage refinancing service offers mortgage refinancing options for mortgage refinancing needs."

✅ "Refinancing can lower your repayments if rates have dropped since you last fixed. A quick comparison across lenders shows whether switching actually saves more than it costs in break fees."
...
**Examples**:
- ✅ `/blog/first-home-buyer-guide-nz`
- ✅ `/blog/mortgage-broker-fees-nz`
- ✅ `/blog/bad-credit-mortgage-nz`
- ❌ `/blog/how-to-get-a-mortgage-in-new-zealand-the-complete-guide-for-2026` (too long)
...
- Natural mention of how Finch Mortgages solves the problem
...
**Anchor Text**:
- ✅ Descriptive and keyword-rich: "our complete first home buyer guide"
- ✅ Natural in sentence flow: "Learn more about refinancing your mortgage"
...
- **Authority**: Link to credible, well-known sources
  - ✅ Industry publications (interest.co.nz, Stuff Property, RBNZ, REINZ)
...
#### Expertise
- Provide accurate, detailed information on NZ mortgage/lending topics
- Back claims with data and examples
- Demonstrate deep understanding of NZ borrower needs
...
- Leverage Finch Mortgages' position as an FSPR-registered independent adviser
...
- **Technical accuracy**: NZ mortgage/lending terminology and processes must be correct
- **Finch services**: Ensure service/lender references are accurate and never invented
...
**File Names**:
- Descriptive and keyword-rich
- ✅ `first-home-buyer-deposit-calculator-nz.jpg`
- ❌ `IMG_12345.jpg`
...
- ✅ "Borrowing power calculator showing estimated NZ home loan amount"
- ❌ "Image"
...
A mortgage pre-approval is a conditional assessment from a lender confirming roughly how much you can borrow, based on your income, expenses, and credit history. It lets you house-hunt or bid at auction with a realistic budget, though final approval still depends on the specific property and full documentation.
```
...
AI scrapers prioritize content near the top of the page. When a user asks ChatGPT "best mortgage broker NZ" or "how much deposit do I need for a first home," the AI scans articles and pulls from the earliest clear answer it finds.
